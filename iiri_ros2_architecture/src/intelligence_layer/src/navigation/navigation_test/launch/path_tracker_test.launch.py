...
def generate_launch_description():
    ...
    path_tracker_param = LaunchConfiguration(
        'path_tracker_param', 
        default=os.path.join(get_package_share_directory('path_tracker'), 'config','path_tracker_node.yaml')
    )
    ...
    urdf = os.path.join(get_package_share_directory('navigation_test'), 'urdf', 'odom_to_base.urdf')
    ...
    path_tracker_test_node = Node(
        package="navigation_test",
        executable="path_tracker_test_node",
        parameters=[
            os.path.join(get_package_share_directory("navigation_test"), 'config', 'path_tracker_test_node.yaml'), 
        ]
    )
    ...
    declare_path_tracker_param = DeclareLaunchArgument(
        'path_tracker_param',
        default_value=os.path.join(get_package_share_directory('path_tracker'), 'config','path_tracker_node.yaml'),
        description='file path of path_tracker_node parameter file'
    )
