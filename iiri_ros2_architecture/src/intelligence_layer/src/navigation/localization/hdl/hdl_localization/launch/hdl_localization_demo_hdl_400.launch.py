...
def generate_launch_description():
    ...
    urdf = os.path.join(get_package_share_directory('hdl_localization'), 'urdf', 'velodyne_hdl_400.urdf')
    ...
    container = ComposableNodeContainer(
        ...
        composable_node_descriptions=[
            ComposableNode(
                ...
                parameters=[
                    {'global_map_parent_directory': "map/hdl_data"},
                    {'global_map_name': "map.pcd"},
    ...
    play_ros_bag = ExecuteProcess(
        cmd=['ros2', 'bag', 'play', os.path.join(os.getcwd(), 'resource', "ros_bag", "hdl_400/")],
        output='screen'
    )
