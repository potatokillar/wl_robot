#!/usr/bin/env python3
"""
QR ARM Platform Launch File
适用于通用ARM平台的QR机器人启动文件
使用 intelligence_layer (3层) 平衡性能和功能
"""
...
def generate_launch_description():
    ...
    enable_follow_arg = DeclareLaunchArgument(
        'enable_follow',
        default_value='false',
        description='Enable smart follow'
    )
    ...
    # 平台启动日志
    log_info = LogInfo(
        msg='[system_bringup] QR ARM Platform started (3-layer architecture)'
    )
