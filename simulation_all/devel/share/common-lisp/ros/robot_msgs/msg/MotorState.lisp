...
(cl:defmethod tauEst-val ((m <MotorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_msgs-msg:tauEst-val is deprecated.  Use robot_msgs-msg:tauEst instead.")
  (tauEst m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MotorState>)))
  ...
  "7b27035d8fd4c0437680bec7c6cb2db9")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MotorState)))
  "Returns md5sum for a message object of type 'MotorState"
  "7b27035d8fd4c0437680bec7c6cb2db9")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MotorState>)))
  ...
  (cl:format cl:nil "float32 q            # motor current position (rad)~%float32 dq           # motor current speed (rad/s)~%float32 ddq          # motor current speed (rad/s)~%float32 tauEst       # current estimated output torque (N*m)~%float32 cur          # current estimated output cur (N*m) ~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MotorState)))
  "Returns full string definition for message of type 'MotorState"
  (cl:format cl:nil "float32 q            # motor current position (rad)~%float32 dq           # motor current speed (rad/s)~%float32 ddq          # motor current speed (rad/s)~%float32 tauEst       # current estimated output torque (N*m)~%float32 cur          # current estimated output cur (N*m) ~%~%"))
